...
\node[below=0.2cm of X] (inputdsc) {\small Input tokens};
...
\node[below=0.5cm of raw] (outdesc) {\small Scaled dot product (raw associations) \\ (each entry divided by $\sqrt{d_{\text{attn}}}$ )};
