...
\section{BERT --- Encoder in detail}
...
\begin{tikzpicture}
	...
	\node (embfn) [param, right of=X, xshift=4cm] {Input emb. $\bm{W_e}, \bm{W_p}$};
...
\node (trlayerN) [param, right of=trlayer1, text centered, text width=2.5cm, xshift=3cm] {Transformer encoder layer N};
