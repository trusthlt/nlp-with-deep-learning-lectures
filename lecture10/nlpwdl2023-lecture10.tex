...
\begin{tikzpicture}
	...
	\node (mlp) [param, right of=norm1, text centered, text width=1cm, xshift=1.2cm, yshift=-1.6cm] {MLP};
	
	\node (sum2) [neuron, right of=norm1, text centered, text width=1.5cm, xshift=2.3cm] {Sum};
